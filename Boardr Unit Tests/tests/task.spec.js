...
describe('Task', () => {
  ...
  describe('toString', () => {
    it('should return the correct string', () => {
      ...
      expect(task.toString()).toContain('Name: test task');
      expect(task.toString()).toContain('Status: Todo');
      expect(task.toString()).toContain(`Due: ${date.toLocaleDateString()} ${date.toLocaleTimeString()}`);
    });
  });
});
